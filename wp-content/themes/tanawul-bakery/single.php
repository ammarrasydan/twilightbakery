					...
					<?php
						...
						while ( have_posts() ) : the_post(); 
							...
							the_post_navigation( array(
								'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'tanawul-bakery' ) . '</span><span aria-hidden="true" class="nav-subtitle text-uppercase">' . __( 'Previous', 'tanawul-bakery' ) . '</span>',
								'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'tanawul-bakery' ) . '</span><span aria-hidden="true" class="nav-subtitle text-uppercase">' . __( 'Next', 'tanawul-bakery' ) . '</span>',
							) );
						}
