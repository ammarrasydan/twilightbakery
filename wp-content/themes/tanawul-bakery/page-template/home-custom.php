            ...
            <div class="carousel-caption">
              <div class="inner_carousel text-capitalize">
                ...
                <?php if( get_theme_mod('tanawul_bakery_slider_content',true) != ''){ ?>
                  <p class="pe-3"><?php $excerpt = get_the_excerpt(); echo esc_html( tanawul_bakery_string_limit_words( $excerpt, esc_attr(get_theme_mod('tanawul_bakery_slider_excerpt_number','20')))); ?></p>
                <?php } ?>
